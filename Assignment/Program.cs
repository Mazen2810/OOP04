...
namespace Assignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Answer : Yes, interfaces can inherit from multiple interfaces
            ...
            // Answer: No, all members are implicitly public

            #endregion
            #region Q8:What is the purpose of an explicit interface implementation in C#?

            // Answer: To provide a clear separation between interface and class members
            #endregion
            #region Q9:In C#, can an interface have a constructor?

            // Answer: Only if the constructor is static
            #endregion
